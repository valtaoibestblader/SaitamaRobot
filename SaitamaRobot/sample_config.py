...
class Config(object):
    ...
    TOKEN = "1905308084:AAEUnhXc0-GDAS4cfefx6EatYtR9EXnFGEM"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    OWNER_ID = 1410558285  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "crimsonflashs"
    SUPPORT_CHAT = "Crimsondragon"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1596039026
